...
export default function HomePage({onAddToCart} : {onAddToCart: (product:Product) => void}) {
  return (
    <div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16">
        <div className="flex items-center justify-between mb-8">
          ...
          <Link to="/termekek" className="text-violet-600 hover:text-violet-700 font-medium text-sm flex items-center gap-1 transition-colors">
            Összes termék

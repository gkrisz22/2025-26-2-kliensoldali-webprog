      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <Link to="/termekek" className="text-slate-600 hover:text-slate-900 text-sm font-medium transition-colors">
              Termékek
            </Link>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            {/* Cart */}
            <Link to="/kosar" className="relative p-2 text-slate-600 hover:text-slate-900 hover:bg-slate-100 transition-colors rounded-lg">
